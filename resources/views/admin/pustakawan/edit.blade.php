                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ showPassword: false }">
                                <input :type="showPassword ? 'text' : 'password'" name="password" 
                                       class="w-full pl-4 pr-10 py-3 bg-white dark:bg-slate-900 border shadow-sm border-gray-200 dark:border-slate-700 focus:border-[#4D9BE2]/50 focus:bg-white rounded-xl text-sm text-[#2F3951] dark:text-slate-100 focus:outline-none focus:ring-4 focus:ring-[#4D9BE2]/5 transition-all @error('password') border-rose-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ showPassword: false }">
                                <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" 
                                       class="w-full pl-4 pr-10 py-3 bg-white dark:bg-slate-900 border shadow-sm border-gray-200 dark:border-slate-700 focus:border-[#4D9BE2]/50 focus:bg-white rounded-xl text-sm text-[#2F3951] dark:text-slate-100 focus:outline-none focus:ring-4 focus:ring-[#4D9BE2]/5 transition-all"
