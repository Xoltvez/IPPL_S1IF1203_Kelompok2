            ...
            @foreach($bukus as $buku)
                <div class="relative flex flex-col">
                    <a href="{{ route('buku.show', $buku->id) }}" class="relative block w-full aspect-[3/4] rounded-2xl overflow-hidden shadow-sm border border-gray-100 bg-[#FCFCFC] group">
                        ...
                        <!-- Hover Overlay with Title and Author (Premium Polish) -->
                        <div class="absolute inset-0 bg-gradient-to-t from-[#2F3951]/90 via-[#2F3951]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex flex-col justify-end p-4">
