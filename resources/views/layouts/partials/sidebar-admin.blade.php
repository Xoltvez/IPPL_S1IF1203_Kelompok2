        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.denda.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all {{ request()->routeIs('admin.denda*') ? 'bg-[#F3F7FB] text-[#4D9BE2] font-semibold' : 'text-gray-500 hover:bg-gray-50' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
