    ...
    <div class="flex-1 overflow-y-auto px-4 py-4 space-y-8 custom-scrollbar">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                {{ request()->routeIs('pustakawan.buku*', 'admin.buku*') ? 'bg-[#F3F7FB] text-[#4D9BE2] font-semibold' : 'text-gray-500 hover:bg-gray-50' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all 
                {{ request()->routeIs('pustakawan.kategori*', 'admin.kategori*') ? 'bg-[#F3F7FB] text-[#4D9BE2] font-semibold' : 'text-gray-500 hover:bg-gray-50' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
